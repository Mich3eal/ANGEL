...
def start(update, context):
    buttons = ButtonMaker()
    buttons.buildbutton("Report Group", "https://t.me/Opleech_updates")
    buttons.buildbutton("Master", "https://t.me/Opleech_updates")
    buttons.buildbutton("Mirror Group", "https://t.me/Opleech_updates")
